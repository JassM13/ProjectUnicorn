...
def stats_widget(user_id=None):
    ...
    return Card(
        Div(
            ...
            style="background: linear-gradient(315deg, rgba(246,205,112, 0.04) 0%, rgba(246,205,112, .2) 100%); padding: clamp(16px, 3vw, 24px); height: 100%; display: flex; flex-direction: column;"
        ),
