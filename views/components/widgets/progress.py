...
def progress_widget():
    return Card(
        Div(
            H2("Trading Goals", style="margin: 0; color: #f6cd70; font-size: clamp(1.2rem, 2vw, 1.5rem); flex: 0 0 auto;"),
            Div(
                Div(
                    P("Monthly Target", style="margin: 0; font-size: clamp(0.8rem, 1.5vw, 0.9rem); flex: 0 0 auto;"),
                    Div(
                        Div(
                            style="width: 75%; height: 100%; background-color: #f6cd70; border-radius: 8px;"
                        ),
                        style="width: 100%; height: min(8px, 1.5vh); background-color: #333; border-radius: 8px; margin: 0.5vh 0;"
                    ),
                    P("$30,000 / $40,000", style="margin: 0; color: #f6cd70; font-size: clamp(0.9rem, 1.8vw, 1.1rem); flex: 0 0 auto;"),
                ...
                Div(
                    ...
                    P("6 / 10 Trades", style="margin: 0; color: #f6cd70; font-size: clamp(0.9rem, 1.8vw, 1.1rem); flex: 0 0 auto;"),
                    style="margin-bottom: min(12px, 2vh); flex: 1; display: flex; flex-direction: column; justify-content: space-between;"
                ),
                Div(
                    ...
                    Div(
                        Div(
                            style="width: 90%; height: 100%; background-color: #f6cd70; border-radius: 8px;"
                        ),
                        style="width: 100%; height: min(8px, 1.5vh); background-color: #333; border-radius: 8px; margin: 0.5vh 0;"
                    ),
                    P("90% Compliance", style="margin: 0; color: #f6cd70; font-size: clamp(0.9rem, 1.8vw, 1.1rem); flex: 0 0 auto;"),
