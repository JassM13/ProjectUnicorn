    ...
    return Div(
        ...
        Div(
            ...
            Div(
                ...
                A(Img(src="/assets/svgs/File/Notebook.svg", alt="Chat"), href="/trades", style=f"display:block; margin: 20px 0; text-align:center; font-size:16px; color:white; opacity: {'1' if active == 'trades' else '0.5'};"),
                A(Img(src="/assets/svgs/Calendar/Calendar_Days.svg", alt="Calendar"), href="/calendar", style=f"display:block; margin: 20px 0; text-align:center; font-size:16px; color:white; opacity: {'1' if active == 'calendar' else '0.5'};"),
            ),
